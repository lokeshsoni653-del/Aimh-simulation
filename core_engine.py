...
class LogisticsConvoy:
    ...
    def calculate_actual_speed(self, weather: str, max_altitude: float, formation: str = "Column Formation (Max Speed)") -> float:
...
class CombatSimEngine:
    ...
    def __init__(self, ambush_threat: str, peak_altitude: float, escorts: bool, mine_sweepers: bool, air_support: bool, posture: str = "Standard Recon Cover"):
